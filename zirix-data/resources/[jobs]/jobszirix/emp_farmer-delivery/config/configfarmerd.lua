...
-- QUANTIDADE QUE IRA GANHAR POR ROTA, MATH.RANDOM ENTRE 100,300 VOCÊ PODE MUDAR.

configfarmerd.farmer2 = { 100 , 300 }

--[ START ]----------------------------------------------------------------------------------------------------------------------------

-- LOCAL PARA INICIAR A ROTA

configfarmerd.ini = {
	['x'] = 1709.4, ['y'] = 4725.37, ['z'] = 42.17
}

--[ DELIVERY ]----------------------------------------------------------------------------------------------------------------------------

-- ITEM QUE SERA PRECISO PARA FAZER A ROTA

configfarmerd.farmer1 = "graos"

--[ DELIVERY ]----------------------------------------------------------------------------------------------------------------------------

-- QUANTIDADE QUE SERA NESECESSARIO PARA ENTREGA, MATH.RANDOM ENTRE 3,6 VOCÊ PODE MUDAR.

configfarmerd.deliveryss = { 3 , 6 }

--[ HASH ]----------------------------------------------------------------------------------------------------------------------------

-- HASH DO VEICULO QUE SERA NESECESSARIO PARA ENTREGA DO LEITE, ESTA YOUGA2

configfarmerd.lastve = 1026149675

--[ ROUTE ]----------------------------------------------------------------------------------------------------------------------------

-- ROTAS PARA ENTREGA.

configfarmerd.deliverys = {
