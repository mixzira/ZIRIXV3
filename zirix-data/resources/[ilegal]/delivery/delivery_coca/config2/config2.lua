...
config2.start = { -452.55, -1685.0, 19.02 }

-- PERMISSAO PARA PODER ENTREGAR
config2.permission = "manager.permissao"

-- LOCALIZAÇÃO DA ENTREGA DAS DROGAS
config2.locs = {
...
--[ CONFIGURAÇÃO DE ENTREGA DAS DROGAS ]-------------------------------------------------------------------------------------------------------------------------

-- ITEM RETIRADO AO ENTREGAR A DROGA.
config2.item = { "cocaina" }

-- QUANTIDADE DE ITEM PARA ENTREGAR.
config2.eqtd = { 3, 8 }

-- ITENS DADOS AO ENTREGAR A DROGA. (Somente 3)
config2.itens = { "dinheiro-sujo" }

-- QUANTIDADE DE ITENS DADOS AO ENTREGAR A DROGA.
-- VALOR RANDOMICO, NECESSARIO 2 VALORES SETADOS.
config2.qtd = { 450, 850 }

-- PERMISSAO DA POLICIA PARA SER AVISADO
config2.ppermission = "policia.permissao"

-- PORCENTAGEM DE CHANCE PARA CHAMAR A POLICIA.
-- PRIMEIRO VALOR: SE MAIOR QUE
-- SEGUNDO VALOR: SE MENOR QUE
config2.percentage = { 1, 30 }      --EX: SE A PORCENTAGEM FOR MAIOR QUE 1 E MENOR QUE 30, A POLICIA SERA AVISADA. (RANDOM DE 0 À 100)