...
config3.permission = "manager.permissao"
...
config3.ppermission = "policia.permissao"

-- PORCENTAGEM DE CHANCE PARA CHAMAR A POLICIA.
-- PRIMEIRO VALOR: SE MAIOR QUE
-- SEGUNDO VALOR: SE MENOR QUE
config3.percentage = { 1, 30 }      --EX: SE A PORCENTAGEM FOR MAIOR QUE 1 E MENOR QUE 30, A POLICIA SERA AVISADA. (RANDOM DE 0 À 100)