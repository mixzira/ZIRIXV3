...
config1.start = { -455.24, -1708.97, 18.72 }

-- PERMISSAO PARA PODER COLETAR
config1.permission = "manager.permissao"
...
config1.itens = { "capsulas", "polvora"}
...
config1.ppermission = "policia.permissao"

-- PORCENTAGEM DE CHANCE PARA CHAMAR A POLICIA.
-- PRIMEIRO VALOR: SE MAIOR QUE
-- SEGUNDO VALOR: SE MENOR QUE
config1.percentage = { 1, 30 }      --EX: SE A PORCENTAGEM FOR MAIOR QUE 1 E MENOR QUE 30, A POLICIA SERA AVISADA. (RANDOM DE 0 À 100)