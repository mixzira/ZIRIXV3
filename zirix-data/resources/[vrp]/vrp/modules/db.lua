vRP.prepare('vRP/create_phone_app_chat',
    [[
...
vRP.prepare('vRP/create_phone_users_contacts',
    [[
...
vRP.prepare('vRP/create_bank_transfer',
    [[
...
vRP.prepare('vRP/create_twitter_accounts',
    [[
...
vRP.prepare('vRP/create_twitter_tweets',
    [[
...
vRP.prepare('vRP/create_twitter_likes',
    [[
...
vRP.prepare('vRP/create_insto_accounts',
    [[
...
vRP.prepare('vRP/create_insto_instas',
    [[
...
vRP.prepare('vRP/create_insto_likes',
    [[
...
CreateThread(function()
    ...
    vRP.execute('vRP/create_twitter_tweets')
    vRP.execute('vRP/create_twitter_likes')
