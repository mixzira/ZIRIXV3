...
items.list = {
	...
	['marijuana'] = { ['index'] = 'marijuana', ['name'] = 'Marijuana', ['type'] = 'use', ['weight'] = 0.5 },

	--[ Miscellaneous ][ Marijuana production ]--------------------------------------------------------------------------

	['folha-marijuana'] = { ['index'] = 'folha-marijuana', ['name'] = 'Folha de Marijuana', ['type'] = 'use', ['weight'] = 0.5 },
	...
	['corpo-aks74u'] = { ['index'] = 'corpo-aks74u', ['name'] = 'Corpo de AKS', ['type'] = 'use', ['weight'] = 0.5 },
	['corpo-glock'] = { ['index'] = 'corpo-glock', ['name'] = 'Corpo de Glock', ['type'] = 'use', ['weight'] = 0.5 },
	['corpo-magnum'] = { ['index'] = 'corpo-magnum', ['name'] = 'Corpo de Magnum', ['type'] = 'use', ['weight'] = 0.5 },
	...
	['placa-metal'] = { ['index'] = 'placa-metal', ['name'] = 'Placa de Metal', ['type'] = 'use', ['weight'] = 0.5 },
	['gatilho'] = { ['index'] = 'gatilho', ['name'] = 'Gatilho', ['type'] = 'use', ['weight'] = 0.5 },
	...
	['wbodyWEAPON_HATCHET'] = { ['index'] = 'machado', ['name'] = 'Machado', ['type'] = 'equip', ['weight'] = 1.0 },
	['wbodyWEAPON_KNUCKLE'] = { ['index'] = 'socoingles', ['name'] = 'Soco Inglês', ['type'] = 'equip', ['weight'] = 1.0 },
	...
	['wbodyWEAPON_PISTOL_MK2'] = { ['index'] = 'czp09', ['name'] = 'CZ P-09', ['type'] = 'equip', ['weight'] = 1.0 },
	...
	['wbodyWEAPON_SNSPISTOL_MK2'] = { ['index'] = 'waltherppk2', ['name'] = 'Walther PPK2', ['type'] = 'equip', ['weight'] = 1.0 },
