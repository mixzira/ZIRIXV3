				...
				<div class="carro" data-carro-name="${item.name}">
                    ...
                    <div class="status">
                        ...
                        <div class="status-motor">
                            ...
                            <div class="icone-motor"><img src="${data.imageService}/motor.png"/></div>
                        ...
                        <div class="status-fuel">
                            ...
                            <div class="icone-fuel"><img src="${data.imageService}/combustivel.png"/></div>
                    ...
                    <div class="licenca">
                        ...
                        <div class="licenca-tax">
                            <div class="icone-tax"><img src="${data.imageService}/tax.png"/></div>
                            <div class="texto-tax"><p>${item.ipva}</p></div>
                        </div>
                        <div class="licenca-valor">
                            <div class="icone-valor"><img src="${data.imageService}/money.png"/></div>
